...
3. Make your changes
4. Write some tests in `/tests`
5. [Submit a pull request](https://github.com/NanoForge-dev/components-systems/compare) (Make sure you follow the [conventional commit format](https://github.com/NanoForge-dev/components-systems/blob/main/.github/COMMIT_CONVENTION.md))
